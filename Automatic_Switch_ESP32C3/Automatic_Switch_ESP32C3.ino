/* Code modified by: Amaro, A,
 * This code is just and example of how you code should be. 
 *  
...
#define WIFI_SSID         // HERE GOES YOUR OWN CONFIGURATION AS STR
#define WIFI_PASS         
#define APP_KEY           
#define APP_SECRET        
...
std::map<String, deviceConfig_t> devices = {
    ...
    {"", {  7, 3, false }},  // HERE YOU DEFINE YOUR OWN PINS AND THE DEVICE ID
    {"", {  8, 4, false }},
    {"", {  6, 10, false }},
...
bool onPowerState(String deviceId, bool &state) {
  ...
  bool nuevo_estado =  !state; // En esta variable declaramos el nuevo estado para el relevador
  digitalWrite(relayPIN, nuevo_estado);             // set the new relay state
  return true;
}
